            ...
            ui.createComponent('product', {
                ...
                options: {
                    "product": {
                        ...
                        "templates": {
                            "orderTime" : '<p class="{{data.classes.product.orderTime}}">Délai de livraiso: 2-3 semaines</p>',
                            "footer": '<footer class="{{data.classes.product.footer}}">'
                            + '<p>En cas de questions, veuillez appeler<br/>0800 930 95</p>'
                            + '<p class="footerTerms">Vous trouverezici les <a class="footerLink" href="www.google.com">conditions générales</a></p>'
                            + '</footer>'
                        },
                        "order": [
                            'price',
